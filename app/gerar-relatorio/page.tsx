          ...
          <div className="container-card p-6 rounded-lg">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select className="w-full bg-panel p-2 rounded">
                  <option>PDF</option>
                  <option>CSV</option>
                </select>
              </div>
              <div>
                ...
                <input className="w-full bg-panel p-2 rounded" placeholder="01/01/2024 - 31/12/2024" />
              </div>
            </div>

            <div className="mt-6 flex items-center justify-between">
              <div>Horas homologadas: <span className="font-bold">{summary.homologated}h</span></div>
              <button className="px-4 py-2 bg-accent text-black rounded">Exportar Relatório</button>
            </div>
